'''
Completed script for NSO Training Day 2 Lab 2
...
def find_hierarchy(hostname, int_id):
    ...
    with ncs.maapi.single_read_trans('admin', 'python') as trans:
        ...
        print("switchport has the following name {}".format(switchport))
        print("switchport is of the class: {}".format(switchport.__class__))
        print("switchport has the following attributes:")
        print(dir(switchport))
        print("\n\n")
...
def main(hostname, int_id, new_vlan=None):
    ...
    with ncs.maapi.single_write_trans('admin', 'python') as trans:
        ...
        print("GigabitEthernet{0} is on voice vlan {1}"
              .format(int_id, interface.switchport.voice.vlan))

        if new_vlan:
            interface.switchport.voice.vlan = new_vlan
...
if __name__ == "__main__":
    find_hierarchy("svl290-gg07-c3850-sw5-econ.cisco.com", "1/0/17")
    main("svl290-gg07-c3850-sw5-econ.cisco.com", "1/0/17", "500")
