'''
Completed script for NSO Training Day 2 Lab 5
...
if __name__ == "__main__":
    print(send_show_cdp("svl290-gg07-c3850-sw5-econ.cisco.com"))
    print(send_dir_command("svl290-gg07-c3850-sw5-econ.cisco.com"))
    print(send_show_command("svl290-gg07-c3850-sw5-econ.cisco.com",
                            "access-lists"))
